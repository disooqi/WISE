...
if __name__ == '__main__':
    wise_relation_extractor = RelationLabeling()
    pos = ['VB', 'IN']
    eval('wise_relation_extractor.VBG("starring")')
    # wise_relation_extractor.IN('for')
    try:
        wise_relation_extractor.VBDF('Mohamed')
    except AttributeError as ae:
        print(f'AttributeError: {ae}')
        print(wise_relation_extractor.accept_relation())
        ...
        print(wise_relation_extractor.state)
        wise_relation_extractor.get_graph().draw('my_state_diagram.png', prog='dot')
